...
# Load and preprocess the image
  ...
  # Load your model
  model = load_model('/home/aditi/Desktop/IMAGE-INPAINTING/trainedmodel (1).h5')
...
# Plot the masked image
  plt.subplot(1, 4, 3)
  masked_image_rgb = cv2.cvtColor((input_image.squeeze() * 255).astype(np.uint8), cv2.COLOR_BGR2RGB)
